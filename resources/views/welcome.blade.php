...
<head>
    ...
    <style>
        ...
        .floating-card {
            ...
            display: flex; align-items: center; gap: .6rem; min-width: 185px;
        }
        .floating-icon {
        ...
        /* ── Feature card (sección blanca) ── */
        .feat-card {
            background: #fff; border-radius: 1.25rem;
            padding: 1.75rem; border: 1px solid #f3f4f6;
            box-shadow: 0 2px 8px rgba(0,0,0,.04);
        }
        .feat-icon {
            width: 3rem; height: 3rem;
            background: #14532d; border-radius: .75rem;
            display: flex; align-items: center; justify-content: center;
            margin-bottom: 1rem;
        }
        ...
        .step-num {
            ...
            display: flex; align-items: center; justify-content: center;
            font-size: 1.4rem; font-weight: 800; color: #14532d;
            margin: 0 auto 1rem;
        }
...
<nav class="bg-white border-b border-gray-100 sticky top-0 z-50">
    <div class="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
        <div class="flex items-center gap-2.5">
            <div class="w-9 h-9 rounded-full border-4 border-green-400 flex items-center justify-center">
...
<section class="bg-white py-20 px-6">
    <div class="max-w-6xl mx-auto">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            ...
            <div class="feat-card">
                <div class="feat-icon">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none"><rect x="3" y="4" width="18" height="18" rx="2" stroke="white" stroke-width="2"/><path d="M16 2v4M8 2v4M3 10h18" stroke="white" stroke-width="2" stroke-linecap="round"/></svg>
                </div>
            ...
            <div class="feat-card">
                <div class="feat-icon">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none"><circle cx="12" cy="12" r="9" stroke="white" stroke-width="2"/><path d="M12 7v5l3 3" stroke="white" stroke-width="2" stroke-linecap="round"/></svg>
                </div>
            ...
            <div class="feat-card">
                <div class="feat-icon">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none"><path d="M12 2L3 7v5c0 5.25 3.75 10.15 9 11.25C17.25 22.15 21 17.25 21 12V7L12 2z" stroke="white" stroke-width="2" stroke-linejoin="round"/><path d="M9 12l2 2 4-4" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
                </div>
            ...
            <div class="feat-card">
                <div class="feat-icon">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none"><circle cx="9" cy="7" r="3" stroke="white" stroke-width="2"/><circle cx="15" cy="7" r="3" stroke="white" stroke-width="2"/><path d="M3 20c0-3.3 2.7-6 6-6h6c3.3 0 6 2.7 6 6" stroke="white" stroke-width="2" stroke-linecap="round"/></svg>
                </div>
    ...
    <div class="max-w-4xl mx-auto text-center">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-10 mb-12">
            ...
            <div class="text-center">
                ...
                <h3 class="font-bold text-white text-lg mb-2">Confirmá y jugá</h3>
        ...
        @auth
            <a href="{{ route('horarios.create') }}" class="btn-green text-base px-8 py-3">
                Comenzar ahora &rsaquo;
            </a>
        @else
            <a href="{{ route('register') }}" class="btn-green text-base px-8 py-3">
                Comenzar ahora &rsaquo;
            </a>
        @endauth
    </div>
...
<section class="py-20 px-6 bg-gray-50">
    <div class="max-w-6xl mx-auto">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            {{-- Cancha Central — Arcilla --}}
            <div class="court-card">
                <div class="court-card-img" style="background: linear-gradient(135deg, #c2410c, #ea580c);">
                    <svg viewBox="0 0 200 120" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <rect x="10" y="8"  width="180" height="104" fill="rgba(255,255,255,.1)" rx="1"/>
                        <rect x="10" y="8"  width="180" height="104" stroke="white" stroke-width="2" fill="none"/>
                        <line x1="100" y1="8"  x2="100" y2="112" stroke="white" stroke-width="1.5"/>
                        <line x1="45"  y1="8"  x2="45"  y2="112" stroke="white" stroke-width="1"/>
                        <line x1="155" y1="8"  x2="155" y2="112" stroke="white" stroke-width="1"/>
                        <line x1="45"  y1="60" x2="155" y2="60"  stroke="white" stroke-width="1"/>
                        <line x1="100" y1="28" x2="100" y2="92"  stroke="white" stroke-width="1"/>
                        <rect x="97"  y="4"   width="6"  height="112" fill="rgba(0,0,0,.2)"/>
                        <circle cx="60" cy="60" r="5" fill="#fde68a"/>
                    </svg>
                ...
                <div class="p-4">
                    ...
                    <p class="text-sm text-gray-400 mt-0.5">
                        Singles · Desde
                        <a href="{{ route('tarifas.index') }}" class="text-green-600 hover:underline">ver tarifas</a>
                    </p>
                </div>
            </div>

            {{-- Cancha Norte — Sintética --}}
            <div class="court-card">
            ...
            {{-- Cancha Sur — Arcilla (No disponible) --}}
            <div class="court-card">
        ...
        <div class="text-center mt-8">
            <a href="{{ route('canchas.index') }}" class="btn-outline inline-flex">
...
{{-- ═══════════════════════════════════
     CTA FINAL — Empieza a jugar hoy
════════════════════════════════════ --}}
<section class="bg-gray-100 py-20 px-6">
    <div class="cta-card">
        <div class="flex justify-center gap-1 text-green-400 text-2xl mb-4">
            ★ ★ ★ ★ ★
        </div>
        ...
        <div class="flex flex-wrap justify-center gap-3">
            @auth
                <a href="{{ route('horarios.create') }}" class="btn-green text-base">
                    Hacer una reserva &rsaquo;
                </a>
                <a href="{{ route('dashboard') }}" class="btn-outline text-base">
                    Ir al Panel
                </a>
            @else
                <a href="{{ route('register') }}" class="btn-green text-base">
                    Registrarme gratis &rsaquo;
                </a>
...
<footer class="bg-gray-900 text-gray-400 text-sm py-8 px-6 text-center">
    <div class="flex items-center justify-center gap-2 mb-2">
        <div class="w-6 h-6 rounded-full border-2 border-green-400 flex items-center justify-center">
